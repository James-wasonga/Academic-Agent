...
//   return (
//     <div 
//       className={`bg-white rounded-xl p-4 sm:p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 cursor-pointer transform ${
...
//           <p className={`text-2xl sm:text-3xl font-bold ${classes.text} mb-1`}>
//             {value}
//           </p>
//           {subtitle && (
...
//           )}
//         </div>
//         <div className={`p-2 sm:p-3 rounded-lg ${classes.bg} ${classes.border} border flex-shrink-0 ml-2`}>
//           <Icon className={`w-5 sm:w-6 h-5 sm:h-6 ${classes.icon}`} />
//         </div>
//       </div>
