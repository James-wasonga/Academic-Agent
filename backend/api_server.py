...
def format_research_output(raw_text: str, query: str) -> str:
    """
    Minimal formatting - let Gemini's markdown shine through
    """
    formatted_text = raw_text.strip()
    
    # Add metadata header
    formatted_report = f"""# Research Analysis: {query}
...
## Research Methodology
This analysis was conducted using advanced AI language model with access to comprehensive knowledge bases, providing insights based on established research, best practices, and current industry standards.
...
def gemini_research(query: str) -> dict:
    ...
    try:
        ...
        # Enhanced detailed prompt for comprehensive research
        prompt = f"""
You are an expert academic researcher. Conduct a comprehensive, detailed research analysis on: "{query}"

Structure your response with these sections:

## 1. INTRODUCTION
Provide context and background (3-4 paragraphs). Explain why this topic is important and what areas it encompasses.

## 2. HISTORICAL CONTEXT AND EVOLUTION
How this topic has developed over time (2-3 paragraphs). Include key milestones and important developments.

## 3. CORE CONCEPTS AND PRINCIPLES
Break down the fundamental concepts into subsections:

### 3.1 First Major Concept
Detailed explanation with examples and real-world applications (2-3 paragraphs)

### 3.2 Second Major Concept
Detailed explanation with examples and real-world applications (2-3 paragraphs)

## 3.3 Third Major Concept
Detailed explanation with examples and real-world applications (2-3 paragraphs)

### 3.4 Additional Key Concepts
Cover any other important principles (2-3 paragraphs)

## 4. CURRENT STATE AND BEST PRACTICES
What are the modern approaches and methodologies? (3-4 paragraphs)
- Industry standards
...
### 5.1 Application Area 1
Detailed description with specific examples (2 paragraphs)

### 5.2 Application Area 2
Detailed description with specific examples (2 paragraphs)

### 5.3 Application Area 3
Detailed description with specific examples (2 paragraphs)

## 6. CHALLENGES AND LIMITATIONS
What are the known issues, trade-offs, and constraints? (3-4 paragraphs)
...
Where is this field heading? (2-3 paragraphs)
- Emerging technologies
- Research areas
- Predicted developments

## 8. CONCLUSION
Summary of key takeaways and recommendations (2-3 paragraphs)
- Main insights
- Practical recommendations
- Final thoughts

Make this comprehensive and detailed - aim for 1500-2000 words minimum. Use proper markdown formatting with headers, subheaders, bullet points, and numbered lists where appropriate. Each section should be substantial and informative.
"""
        ...
        response = model.generate_content(
            ...
            generation_config={
                ...
                "top_p": 0.9,
                "top_k": 40,
                "max_output_tokens": 5096,  # Increased for longer responses
            }
        )
        ...
        return {
            "topic": query,
            "summary": formatted_summary,
            "sources": "Comprehensive academic research and verified references from established knowledge bases",
            "tool_used": ["AI-powered research system", model_name_used],
            "timestamp": datetime.now().isoformat(),
            "id": f"research_{datetime.now().timestamp()}",
            "mode": "real_ai",
            "research_quality": "professional",
...
Please ensure:
1. Gemini API key is properly configured
...
*Generated on {datetime.now().strftime("%B %d, %Y at %I:%M %p")}*
        """,
        "sources": "System fallback mode - limited functionality",
        "tool_used": ["fallback-mode"],
        "timestamp": datetime.now().isoformat(),
        "id": f"research_{datetime.now().timestamp()}",
        "mode": "fallback",
...
if __name__ == "__main__":
    print("🚀 Starting Academic Research Agent API v2.0...")
    print(f"🔑 Gemini AI: {'Enabled' if HAS_GEMINI else 'Disabled'}")
    print(f"📊 Ratings System: Enabled")
    uvicorn.run(app, host="0.0.0.0", port=PORT, reload=False)